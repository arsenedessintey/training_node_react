...
CREATE TABLE `Field` (
    ...
    `explication` VARCHAR(2048) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Field` ADD CONSTRAINT `Field_sheet_id_fkey` FOREIGN KEY (`sheet_id`) REFERENCES `Sheet`(`sheet_id`) ON DELETE SET NULL ON UPDATE CASCADE;
